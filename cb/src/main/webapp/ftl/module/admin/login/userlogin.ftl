...
<head>
	...
	<meta content="清远市保密局综合业务平台" name="description" />
	<meta content="清远市保密局综合业务平台" name="keywords" />
	...
	<body class="login">
		...
		<div class="content">
			...
			<form action="javascript:void(0)" name="loginForm" class="login-form" method="post">
				...
				<div id="noPermissionError" class="alert alert-danger display-hide">
					<button class="close" data-close="alert"></button>
					<span> 该用户未分配权限！ </span>
				</div>
				<div id="resetPasswordSuccess" class="alert alert-success display-hide">
					<button class="close" data-close="alert"></button>
					<span> 密码重置成功！ </span>
				</div>
				<div class="form-group">
					...
					<div class="input-icon">
						...
						<input class="form-control" type="text" autocomplete="off" placeholder="用户名" name="j_username" />
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="input-icon">
						<i class="fa fa-key"></i> 
						<input type="text" id="kaptcha" name="kaptcha" class="form-control kaptcha" placeholder="输入验证码" />
