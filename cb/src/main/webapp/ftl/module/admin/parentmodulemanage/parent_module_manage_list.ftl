	...
	<div class="col-md-12">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-shopping-cart"></i>父模块管理
				</div>
			</div>
			<div class="portlet-body">
				<div class="table-toolbar">
					<div class="btn-group">
						<a class="btn blue" id="addParentModuleManage"> 添加父模块
				...
				<div class="table-container">
					...
					<table class="table table-striped table-bordered table-hover"
						id="adminParentModuleManageList">
						<thead>
							...
							<tr role="row" class="filter">
								...
								<td>
									<input type="text" class="form-control form-filter input-sm" name="pamo_describe">
								</td>
								<td>
									<select name="pamo_use_status" class="form-control form-filter input-sm">
										<option value=""> </option>
								...
								<td>
									<input type="text" class="form-control form-filter input-sm" name="pamo_sort">
								</td>
								<td>
									<input type="text" class="form-control form-filter input-sm" name="pamo_icon">
								</td>
...
<!--START MODAL-->
<div id="parentModuleModel" class="modal fade" tabindex="-1" data-keyboard="false" data-width="600">
</div>
<!--END MODAL-->

<script src="assets/custom/scripts/admin/parentmodulemanage/parent_module_manage_list_main.js" type="text/javascript"></script>
