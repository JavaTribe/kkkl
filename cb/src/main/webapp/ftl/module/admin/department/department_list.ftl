...
<div class="row">
	<div class="col-md-12">
		...
		<ul class="page-breadcrumb breadcrumb">
			...
			<li><a href="#">初始化管理</a> <i class="fa fa-angle-right"></i></li>
			<li><a href="#">部门架构</a></li>
		</ul>
	...
	<div class="col-md-12">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-shopping-cart"></i>部门架构
				</div>
			</div>
			<div class="portlet-body">
				<div class="table-toolbar">
					<div class="btn-group">
						<a class="btn blue" id="addDepartment"> 添加部门 
					...
					<table class="table table-striped table-bordered table-hover"
						...
						<thead>
							...
							<tr role="row" class="filter">
								...
								<td>
									<input type="text" class="form-control form-filter input-sm" name="depa_no">
								</td>
								<td>
									<input type="text" class="form-control form-filter input-sm" name="grad_grade_name">
								</td>
								<td>
									<input type="text" class="form-control form-filter input-sm" name="parent_depa_name">
								</td>
								<td>
									<input type="text" class="form-control form-filter input-sm" name="parent_depa_no">
								</td>
...
<script src="${base}/assets/custom/scripts/admin/department/department_list_main.js" type="text/javascript"></script>
